function ptD = Assignment3_searchD(obstaclePos, obstacleRadius, searchDelta, considerArm, refinedCentre)
%% set up variables
close all
...
min_improve = 0.01;
if nargin == 4
    searchBoundary = 1.5*r;
elseif nargin == 5
    searchBoundary = search_Delta*15;
end

for dx = -searchBoundary:search_Delta:searchBoundary
    for dy = -searchBoundary:search_Delta:searchBoundary
        if nargin == 4
